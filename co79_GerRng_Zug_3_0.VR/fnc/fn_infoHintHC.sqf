...
_txt2 = parseText format["<t size='1.2' color='#2db92d'>ID: %3 = HC 1: %1 Units in %2 Groups</t>", _unitsHC1, count _grpsHC1, _ID_HC1];
_txt3 = parseText format["<t size='1.2' color='#e6e600'>ID: %3 = HC 2: %1 Units in %2 Groups</t>", _unitsHC2, count _grpsHC2, _ID_HC2];
_txt4 = parseText format["<t size='1.2' color='#FF00FF'>ID: %3 = HC 3: %1 Units in %2 Groups</t>", _unitsHC3, count _grpsHC3, _ID_HC3];
