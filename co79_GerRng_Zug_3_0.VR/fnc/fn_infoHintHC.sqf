...
private _grpsServer = allGroups select { _ID_Server == groupOwner _x };
private _grpsHC1 = allGroups select { _ID_HC1 == groupOwner _x };
private _grpsHC2 = allGroups select { _ID_HC2 == groupOwner _x };
private _grpsHC3 = allGroups select { _ID_HC3 == groupOwner _x };

// count units in groups
private _unitsServer = 0;
...
private _txt2 = parseText format["<t size='1.2' color='#2db92d'>ID: %1 = HC 1 nicht verbunden</t>", _ID_HC1];
private _txt3 = parseText format["<t size='1.2' color='#e6e600'>ID: %1 = HC 2 nicht verbunden</t>", _ID_HC2];
private _txt4 = parseText format["<t size='1.2' color='#FF00FF'>ID: %1 = HC 3 nicht verbunden</t>", _ID_HC3];

// create Info Hint
private _separator = parseText "<br />------------------------<br />";
private _txt1 = parseText format["<t size='1.2' color='#F5F5F5'>ID: %3 = Server: %1 Units in %2 Groups</t>", _unitsServer, count _grpsServer, _ID_Server];
...
private _txt5 = parseText format["<t size='1.2' color='#F5F5F5'>Gesamt: %1 Units in %2 Groups</t>", (_unitsServer+_unitsHC1+_unitsHC2+_unitsHC3), (count _grpsServer)+(count _grpsHC1)+(count _grpsHC2)+(count _grpsHC3)];
private _txtFinal = composeText [_txt1, _separator, _txt2, _separator, _txt3, _separator, _txt4, _separator, _txt5];
