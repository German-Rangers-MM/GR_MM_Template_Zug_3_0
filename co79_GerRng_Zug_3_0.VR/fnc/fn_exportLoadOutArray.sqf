...
if (_loNa in ["Lima","ZugSani","Mike_AvD","Mike_Sani","Sanitaeter","Sanitaeter_WaGru"]) then { _medT = 2; 		}; // Arzt
...
_clear	= composeText ["player setVariable [",str "ace_safemode_safedweapons"+",",str [],"];",_br];	
_lock	= "[ACE_player, currentWeapon ACE_player, currentMuzzle ACE_player] call ace_safemode_fnc_lockSafety;";		
_options = composeText [_s,_br,_c,_tab,"ACE Optionen fuer Spieler",_br,_s,_br,_c,_tab,"Medic:",_br,_medic,_br,_c,_tab,"Combat Engineer:",_br,_engi,_br,_c,_tab,"Explosive Specialist:",_br,_eod,_br,_c,_tab,"Waffe sichern",_br,_clear,_lock];
