...
private _line3 = format ["<t color='#ffffff' size='1'>%1<br/>____________________</t><br/><t color='#ffffff' size='5'>%2</t><br/><br/><img image='images\GermanRangersLogo.paa' shadow='0' size='8'/>",_titleOrtEinheit,_titleMissionsname];
