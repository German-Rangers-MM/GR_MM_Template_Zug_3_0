...
//------------------------------------------------------------------
//------------------------------------------------------------------
player setVariable ["GR_unitLoadout","Sierra_TF",true];
...
player setUnitLoadout [
    ["SPS_hk416_11_sl_t_ctr_vfg_a7_black_f", "muzzle_snds_HXQD556K_black_M", "sps_M300C_RAID_IR", "SPS_EOTech_Black_5xMAG_up", 
        ["SPS_HKG3PMAG_30Rnd_556x45_B_Mk318", 30], [], "sps_atlas_bipod_m_blk"
    ],
    [],
    ...
    ["CUP_U_B_GER_Fleck_Crye", [
        ...
        ["ACE_MapTools", 1], ["ACE_Flashlight_XL50", 1], ["ACE_HuntIR_monitor", 1], 
    ...
    ["CUP_V_B_GER_Armatus_BB_Fleck", [
        ...
        ["SmokeShellRed", 2, 1], ["SmokeShellPurple", 2, 1], ["B_IR_Grenade", 2, 1]
    ]],
